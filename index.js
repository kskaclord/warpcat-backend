...
    // *** ERKEN READY: Splash'ı hemen kapatır (GLOBAL SDK yöntemi kullanıldı) ***
    + '<script src="https://esm.sh/@farcaster/miniapp-sdk@0.2.1/dist/index.js"></script>'
    + '<script>'
    + "  (async()=>{try{window.farcasterMiniAppSdk.actions.ready();}catch(e){console.warn('early ready failed',e);}})();"
    + '</script>'
